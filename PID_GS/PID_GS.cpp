...
void PID_GS_controller::init(double dt_, double Kp_, double Ki_, double Kd_, double I_max_, double u_max_, bool d_filter_=false, double fc_){
    dt = dt_;
    Kp = Kp_;
    Ki = Ki_;
    Kd = Kd_;
...
double PID_GS_controller::update(double e_k, double u_ff_){
    u_ff = u_ff_;
